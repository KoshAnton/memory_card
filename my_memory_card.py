...
question_list = []
q1 = Question('2+2?', '4', '3', '2', '5')
question_list.append(q1)
q2 = Question('100/4?', '25', '20', '35', '50')
question_list.append(q2)
q3 = Question('123-72?', '51', '49', '50', '52' )
question_list.append(q3)
q4 = Question('CH4 это?', 'метан', 'этан', 'пропан', 'бутан')
question_list.append(q4)
q5 = Question('Собака это?', 'животное', 'птица', 'рыба', 'насекомое')
question_list.append(q5)
q6 = Question('248+257?', '505', '504', '506', '515')
question_list.append(q6)
q7 = Question('Какой из них настоящий хим. элемент?', 'P', 'Fs', 'Re', 'Bp')
question_list.append(q7)
q8 = Question('1000-7?', '993', '994', '995', '...')
